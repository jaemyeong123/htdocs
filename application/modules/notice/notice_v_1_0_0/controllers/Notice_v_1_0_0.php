...
*/
	...
	public function notice_reg_in(){
		...
		$title = $this->_input_check("title",array("regular_msg"=>"공지사항 제목을 입력해주세요."));
		...
		# model. 공지사항 등록
		$result = $this->model_notice->notice_reg_in($data);
...
*/
	...
	public function notice_mod_up(){
		$notice_idx = $this->_input_check("notice_idx",array("empty_msg"=>"공지사항 키가 누락되었습니다."));
		$title = $this->_input_check("title",array("empty_msg"=>"공지사항 제목을 입력해주세요."));
		$contents = $this->_input_check("contents",array("empty_msg"=>"내용을 입력해주세요."));
		$img_path = $this->_input_check("img_path[]",array());
		...
		# model. 공지사항 수정
		$result = $this->model_notice->notice_mod_up($data);
	...
	public function notice_state_mod_up(){
		...
		# model. 공지사항 상태 변경
		$result = $this->model_notice->notice_state_mod_up($data);
	...
	public function notice_del(){
		...
		# model. 공지사항 삭제
		$result = $this->model_notice->notice_del($data);
